...
\footnote{这种等同性的用法通常被称为 \define{$\beta$-变换} \indexsee{beta-变换@$\beta $-变换}{$\beta$-化简} \indexsee{变换!beta@$\beta $-}{$\beta$-化简} 或 \define{$\beta$-化简}. \index{beta-化简@$\beta $-化简|footstyle} \indexsee{化简!beta@$\beta $-}{$\beta$-化简} },
即一个定义等式:
